			...
			<ul>				
				...
				<li>
					<a href="#core.activity">
						{phrase var='core.activity_points'}
						<span id="js_global_total_activity_points">({$iTotalActivityPoints|number_format})</span>
					</a>
				</li>
				{/if}
				{if Phpfox::isModule('subscribe') && Phpfox::getParam('subscribe.enable_subscription_packages')}
				<li>
					<a href="#subscribe.listUpgrades" rel="welcome_info_holder_custom">
						{phrase var='subscribe.membership_membership_name' membership_name=$sUserGroupFullName}
					</a>
				</li>				
				{/if}
				<li>
					<a href="{url link='user.profile'}">
						{phrase var='core.edit_profile'}
					</a>
				</li>
				<li>
					<a href="{url link='profile'}">
						{phrase var='core.profile_views'}
