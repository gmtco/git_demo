<div id="request_container">
	...
	<div id="app_request_holder">		
		...
		<div id="app_request_perm_list">
			...
			<div class="permission">	
				...
				<div class="allow_or_not">
					<select class="form-control select_allow" id="{$aPermission.sVariable}">
		...
		<div id="app_request_title">		
			...
			<div class="">
				<a href="#" class="btn btn-primary" onclick="$Core.box('like.browse', 300, 'type_id=pages&amp;item_id={$aApp.page_id}&amp;force_like=true'); return false;">
	...
	<div id="confirmation">
		<div id="confirmation_buttons">
			<ul class="table_clear_button">
				<li><input type="button" class="btn btn-primary" value="{phrase var='apps.install'}" onclick="allowApp({$aApp.app_id});" /></li>
				<li><input type="button" class="btn btn-default" value="{phrase var='apps.don_t_install'}" onclick="window.location = oParams['sJsHome'];" /></li>
			</ul>
			<div class="clear"></div>
		</div>		
