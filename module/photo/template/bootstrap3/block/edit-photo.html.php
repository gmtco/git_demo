...
<div id="photo_edit_item_id_{$aForms.photo_id}" class="row photo_edit_row">
	<div class="col-xs-5">
		<div class="t_center">
		...
		<div class="p_4">
			...
			<div class="photo_edit_input">				
				<div class="table">
					<div class="table_left">
						<label>{phrase var='photo.privacy'}</label>
					</div>
			...
			<div class="photo_edit_input">
				...
				<div class="p_top_4">
					<select class="form-control" name="val[{$aForms.photo_id}][move_to]" style="width:180px;">	
	...
	{if isset($bSingleMode)}
		<div class="col-xs-12">
			<input type="submit" value="{phrase var='photo.update'}" class="btn btn-primary btn-block" />
		</div>
		<div class="clear"></div>
	{/if}
</div>
