 ...
 * @version    $Id: followingjobs.html.php 22002 2013-08-17 14:44:49 $
 * @author     CEOfox, Inc.
 */
?>
<?php
...
<div class="job two_cols">
    <div class="col-xs-12 col-sm-9 col-md-9 col-lg-9">
        <div class="txt_header">{phrase var='job.following_jobs'}</div>
        ...
        <table class="tbl">
            ...
            <tbody>
                ...
                <tr id="unfollow_job_{$aPosition.position_id}">
                    <td><a class="link" href="{$aPosition.link}">{$aPosition.title}</a></td>
                    <td class="c">{$aPosition.time_stamp|date:'core.global_update_time'}</td>
                    <td class="c">
                        <a href="javascript:void(0);" onclick="$.ajaxCall('job.position.follow', 'cid={$aCurrentCandidate.candidate_id}&amp;pid={$aPosition.position_id}&amp;s=0');">{phrase var='job.unfollow_job'}</a>
                    </td>
                </tr>
                {/foreach}
            </tbody>
