<form class="mac-form-filter-user" method="post" action="{if isset($aCallback.url_home)}{url link=$aCallback.url_home view=$sView}{else}{url link='user.browse' view=$sView}{/if}">
...
{/if}
	...
	<ul id="js_user_browse_advanced_link">
		<li><a class="btn btn-default" href="#" onclick="$('#js_user_browse_advanced').show(); return false;" id="user_browse_advanced_link">{phrase var='user.advanced_filters'}</a></li>
