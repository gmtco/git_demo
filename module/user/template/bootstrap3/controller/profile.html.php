...
<div class="table js_custom_groups js_custom_group_basic">
	<div class="table">
		...
		<div class="table">
			...
			<div class="input-group">
				...
				<input placeholder="{phrase var='user.city'}" class="form-control" type="text" name="val[city_location]" id="city_location" value="{value type='input' id='city_location'}" size="30" />
			</div>
			<div class="clear"></div>
		</div>
		...
		<div class="table">
			...
			<div class="table_right">
				<textarea class="form-control" cols="40" rows="5" id="signature" name="val[signature]">{$aForms.signature}</textarea>
			</div>
			<div class="clear"></div>
		</div>		
		{/if}
		...
		<div class="table">
			...
			<div class="table_right">
				<select class="form-control" name="val[use_timeline]">
	...
	<div class="table_clear">
		<input type="submit" value="{phrase var='user.update'}" class="btn btn-primary btn-block" id="js_custom_submit_button"> <span id="js_custom_update_info"></span>
	</div>
</form>