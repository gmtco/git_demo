...
<div id="js_shoutbox_messages" class="label_flow" style="height:300px; margin:0px 10px 5px 0px; position:relative;">    
...
<div id="js_shoutbox_form">
	...
	{/if}
		<div><input id="js_shoutbox_input" class="form-control" type="text" name="shoutout" size="20" maxlength="255" value="" /></div>
	</form>
</div>
<div id="js_shoutbox_message"></div>
{if Phpfox::getParam('shoutbox.shoutbox_is_live')}
<script type="text/javascript">setTimeout("$.ajaxCall('shoutbox.getMessages'{if isset($aCallbackShoutbox.module)}, 'module={$aCallbackShoutbox.module}&item={$aCallbackShoutbox.item}'{/if})", {$iShoutboxRefresh});</script>
{/if}