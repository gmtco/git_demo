<li class="list-group-item mac-forum-post-box">
					...
					<div class="forum_user_info_holder_inner">
						...
						<div class="forum_user_info">
							<div class="forum_thread_photo">
								{img user=$aPost suffix='_120_square' class="mac-img-fullwidth" max_width=100 max_height=100}
							</div>
			...
			<div class="col-lg-10 ">
						...
						<div class="forum_search_post">
							<ul class="extra_info_middot">
								<li>
									{phrase var='forum.posted_in'} 
									"<a href="{permalink module='forum.thread' id=$aPost.thread_id title=$aPost.thread_title}">
									{$aPost.thread_title|clean}</a>"
								</li>
								<li>&middot;</li>
								<li>{$aPost.time_stamp|convert_time}</li>
							</ul>
						</div>
						{/if}
