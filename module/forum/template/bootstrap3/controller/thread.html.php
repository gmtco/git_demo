...
<div class="forum_header_menu">
	...
	<ul class="nav navbar-default nav-pills mac-boot-megamenu">
		...
		<li class="dropdown pull-right">
			...
			<a data-toggle="dropdown" href="#">
				{phrase var='forum.thread_tools'} <i class="icon-arrow-down"></i>
			</a>
...
<div class="panel panel-primary">
	<div class="panel-heading">
		<h3 class="panel-title">{phrase var='forum.viewing_single_post'}</h3>
		<span class="badge pull-right">
			{phrase var='forum.thread'}: 
			<a href="{permalink module='forum.thread' id=$aThread.thread_id title=$aThread.title}" title="{$aThread.title|clean}">
				{$aThread.title|clean|shorten:50:'...'}
			</a>
		</span>
	</div>
