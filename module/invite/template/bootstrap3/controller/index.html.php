	...
	<form method="post" action="{if $bIsRegistration}{url link='invite.register'}{else}{url link='invite'}{/if}">
		<div class="table">
			<div class="table_left">
				<label>{phrase var='invite.subject'}</label>
			</div>
		...
		<div class="table">
			<div class="table_left">
				<label>{phrase var='invite.from'}</label>
			</div>
			<div class="table_right_text">
				{$sSiteEmail}
			</div>
		...
		<div class="table">
			...
			<div class="table_right">
				<textarea placeholder="{phrase var='invite.separate_multiple_emails_with_a_comma'}" class="form-control input-lg" id="emails" name="val[emails]" onkeydown="$Core.resizeTextarea($(this));" onkeyup="$Core.resizeTextarea($(this));"></textarea>
		...
		<div class="table_clear">
			<input type="submit" value="{phrase var='invite.send_invitation_s'}" class="btn btn-primary btn-block btn-lg" />
		</div>
	</form>
