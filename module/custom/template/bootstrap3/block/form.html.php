<div class="custom_block_form">
			{if $aSetting.var_type == 'textarea'}
				<textarea class="custom_textarea form-control" name="custom[{$aSetting.field_id}]">{if isset($aSetting.value)}{$aSetting.value|clean}{/if}</textarea>
			{elseif $aSetting.var_type == 'text'}
				<input class="form-control" type="text" name="custom[{$aSetting.field_id}]" value="{if isset($aSetting.value)}{$aSetting.value|clean}{/if}" size="30" maxlength="255" />
