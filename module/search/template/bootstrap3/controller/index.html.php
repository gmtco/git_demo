...
<div class="main_search_bar">
	<form class="mac-form-search form-search" method="post" action="{url link='search'}">
		<div class="input-group">
			<input placeholder="{phrase var='core.search_dot'}" type="text" name="q" value="{if isset($sQuery)}{$sQuery|clean}{/if}" class="form-control input-lg" />
			<span class="input-group-btn">
				<input type="submit" value="{phrase var='core.search'}" class="btn btn-danger btn-lg" />
			</span>
		</div>
	</form>
</div>
