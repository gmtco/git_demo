<div class="comment_mini">
	...
	{/foreach}
	{if $aFeed.like_count > 0} {phrase var='feed.and'} 
	<a href="#" onclick="tb_show('{phrase var='feed.people_who_like_this' phpfox_squote=true}', $.ajaxBox('feed.likeList', 'height=410&amp;width=300&amp;feed_id={$aFeed.feed_id}')); return false;">
		{$aFeed.like_count} {if $aFeed.like_count == 1}{phrase var='feed.other_person'}{else}{phrase var='feed.others'}{/if}
	</a> 
	{/if} 
	{phrase var='feed.like_this'}.
	{/if}
</div>