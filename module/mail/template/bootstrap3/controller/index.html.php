...
<div style="position:absolute; right:0px; top:-15px;">
	<a href="#" onclick="if (confirm('{phrase var='mail.are_you_sure'}')) {l} $.ajaxCall('mail.deleteFolder', 'id={$iFolder}'); {r} return false;">
		<i class="icon-remove"></i> {phrase var='mail.delete_this_list'}
	</a>
</div>
{/if}
{if count($aMails)}
