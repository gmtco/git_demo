{if count($aPins)}
<div id="mac-bootpin" class="mac-bootpin-single dont-unbind mac-bootpin-status">
  {foreach from=$aPins name=pin item=aPin}
    ...
    {/if}
    <div class="mac-element mac-browsing-{$aPin.ITEMTYPENAME} mac-box {if true} col-xs-12 col-sm-6 col-md-4 col-lg-3{/if}">
