...
<div id="mac-content" class="col-xs-12 col-sm-12 col-md-7 col-lg-7 col-md-push-2 col-lg-push-2 col-main-{$sMacBodyClass}">
{elseif isset($bMacLoadRightBlock)}
<div id="mac-content" class="col-xs-12 col-sm-8 col-md-9 col-lg-9 col-main-{$sMacBodyClass}">
...
{else}
<div id="mac-content" class="animated fadeInDown col-xs-12 col-main-{$sMacBodyClass}">
{/if}
