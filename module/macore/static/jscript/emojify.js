    ...
    $('textarea').textcomplete([
      { // emoji strategy
        ...
        template: function (value) {
          return '<img src="' + oParams['sJsHome'] + 'module/macore/static/image/emoji/' + value + '.png"/> ' + value;
        },
    ...
    $('.mac-share-txt, .mac-js_comment_feed_textarea').addClass('dont-unbind');
    ...
    $Behavior.macEmojiInit = function() {
