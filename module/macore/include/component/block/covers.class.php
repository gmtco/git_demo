 ...
 * Profile Covers
 */
class Macore_Component_Block_Covers extends Phpfox_Component
{
	/**
	...
	{	
		...
		$aCoversPhoto = Phpfox::getService('macore')->getCoversPhoto($aUser['user_id']);
		$aCoverPhoto = Phpfox::getService('photo')->getCoverPhoto($aUser['cover_photo']);
		
		if (!count($aCoversPhoto) || !$aCoverPhoto)
		{
			return false;
		}
