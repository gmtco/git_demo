    ...
    <div class="box-caption-bottom clearfix">
        <div class="mac-favorites-link">
          ...
          <ul class="dropdown-menu" role="menu">
            ...
            {if ( (Phpfox::getUserId() == $aPin.user_id && (Phpfox::getUserParam('quiz.can_edit_own_questions') || Phpfox::getUserParam('quiz.can_edit_own_title'))) ||
                  (Phpfox::getUserId() != $aPin.user_id && (Phpfox::getUserParam('quiz.can_edit_others_questions') || Phpfox::getUserParam('quiz.can_edit_others_title'))))}
            <li>
              <a href="{url link='quiz.add' id=$aPin.ITEMID}" title="{phrase var='quiz.edit'}">
            ...
            <li>
              <a title="{phrase var='core.delete'}" href="#" onclick="if(confirm('{phrase var='macore.sure_delete_this_post'}'))$.ajaxCall('pin.deletePin','delete={$aPin.ITEMID}&media=quiz&feedid={$aPin.feed_id}');return false;">
