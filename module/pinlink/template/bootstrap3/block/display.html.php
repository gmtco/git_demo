...
<div id="mac-bootpin" class="mac-bootpin-single dont-unbind mac-bootpin-link" style="opacity:0;-ms-filter: 'progid:DXImageTransform.Microsoft.Alpha(Opacity=0)';filter: alpha(opacity=0);-moz-opacity: 0;-khtml-opacity: 0;"> <!-- #start -->
