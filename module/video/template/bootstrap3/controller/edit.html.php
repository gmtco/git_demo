...
<form class="mac-form-video-edit form-horizontal" method="post" action="{url link='video.edit'}" onsubmit="return startProcess(true, false);" enctype="multipart/form-data">
	...
	<div id="js_video_block_detail" class="js_video_block page_section_menu_holder">
		...
		<div class="table_clear">
			<input type="submit" value="{phrase var='video.save'}" class="btn btn-danger btn-block btn-lg" />
		</div>		
	</div>
	...
	<div id="js_video_block_photo" class="js_video_block page_section_menu_holder" style="display:none;">	
		<div id="js_video_block_photo_holder">
			...
			<div id="js_submit_upload_image" class="table_clear"{if !empty($aForms.image_path)} style="display:none;"{/if}>
				<input type="submit" value="{phrase var='video.save'}" class="btn btn-primary" />
			</div>
		</div>		
	</div>	
