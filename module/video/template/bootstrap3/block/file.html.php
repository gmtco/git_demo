<div id="js_video_detail"></div>
	<div id="js_video_process" style="display:none;">
		<div class="alert alert-info">
			<i class="icon-spinner icon-spin icon-2x"></i> Uploading your video...			
		</div>
	</div>	
	...
	{/if}	
		...
		<div id="js_upload_inner_form">
			...
			{/if}
			<div class="alert alert-info">{phrase var='video.upload_problems_try_the_basic_uploader' link=$sMethodUrl}</div>				
			{else}				
			...
			<div class="table_clear">
				<input type="submit" value="{phrase var='video.upload'}" class="btn btn-primary btn-block" />
			</div>
			{/if}
			{/if}
